...
export default function ClientsPage() {
      ...
      render: (_v, record) => {
        return (
          <ClientInboundChips
            ...
            labelForId={inboundLabel}
            titleForId={inboundFullLabel}
            nodeLabelForId={inboundNodeLabel}
          />
        );
      },
    },
  ...
  ], [t, togglingEmail, clientBucket, isOnline, inboundsById, nodesById, filters, allGroups, datepicker, trafficDiff, clientSpeed]);
