...
install() {
    bash <(curl -Ls https://raw.githubusercontent.com/Fourgetu/3x-ui/main/install.sh)
    if [[ $? == 0 ]]; then
        if [[ $# == 0 ]]; then
            start
        else
...
installed_script_url() {
    ...
    if [[ "$ver" =~ ^[0-9]+\.[0-9]+\.[0-9]+$ ]] && curl -fsIL -o /dev/null "https://raw.githubusercontent.com/Fourgetu/3x-ui/v${ver}/x-ui.sh"; then
        ...
        echo "https://raw.githubusercontent.com/Fourgetu/3x-ui/main/x-ui.sh"
    fi
}
...
legacy_version() {
    ...
    install_command="bash <(curl -Ls "https://raw.githubusercontent.com/Fourgetu/3x-ui/v$tag_version/install.sh") v$tag_version"
...
uninstall() {
    ...
    echo -e "${green}bash <(curl -Ls https://raw.githubusercontent.com/Fourgetu/3x-ui/main/install.sh)${plain}"
    echo ""
